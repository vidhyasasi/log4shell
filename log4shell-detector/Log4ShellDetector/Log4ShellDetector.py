...
import traceback
import sys
from anyascii import anyascii # to decode unicodes to ascii
...
class detector(object):
    ...
    # Decodes any unicode charecters
                ...
                with open(file_path, 'r') as logfile:
                    ...
                    for line in logfile:
                        ...
                        if result:
                            ...
                            matches_in_file.append(matches_dict)
            # Plain Text with non ASCII charecters
            else:
                print("Starting to check the file")
                with open(file_path, 'r') as logfile:
                    c = 0
                    for line in logfile:
                        c += 1
